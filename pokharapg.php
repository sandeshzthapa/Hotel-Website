...
<body>
  <h1>Pokhara: 6 properties found </h1>

  <div class="room-card">
    <div class="room-photo">
      <img src="pokh.jpg" alt="Room Photo 1">
    </div>
  ...
  <div class="room-card">
    <div class="room-photo">
      <img src="pokh1.jpg" alt="Room Photo 2">
    </div>
    <div class="room-details">
      <h2>Hotel Iceland</h2>
  ...
  <div class="room-card">
    <div class="room-photo">
      <img src="pokh3.jpg" alt="Room Photo 3">
    </div>
    <div class="room-details">
      <h2>Hotel Orchid</h2>
  ...
  <div class="room-card">
    <div class="room-photo">
      <img src="pokh4.jpg" alt="Room Photo 4">
    </div>
    <div class="room-details">
  ...
  <div class="room-card">
    <div class="room-photo">
      <img src="pokh5.jpg" alt="Room Photo 5">
    </div>
    <div class="room-details">
      <h2>Hotel Barahi</h2>
  ...
  <div class="room-card">
    <div class="room-photo">
      <img src="pokhara.jpg" alt="Room Photo 6">
    </div>
    <div class="room-details">
      <h2>Hotel Shaara</h2>
